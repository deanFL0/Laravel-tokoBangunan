...
<body>
    <div class="container">
        ...
        <form action="{{ route('penjualan.store') }}" method="POST">
            @csrf
            <input type="text" class="form-control" id="id" name="id" value="{{ $penjualan->id }}" hidden>
            <div class="mb-3">
                <label for="tgl" class="form-label">tgl</label>
                <input type="datetime-local" class="form-control" id="tgl" name="tgl" value="{{ $penjualan->tgl }}">
            </div>
            <div class="mb-3">
